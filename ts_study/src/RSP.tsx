...
//typeof, keyof 어떻게 써야 원하는 값을 얻을 수 있는지 확인해보기 - 중요
//type ImgCoords = "0" | "-142px" | "-284px" 이렇게도 설정할수는 있지만 값이 바꼈을 때를 대비해서 1번 방법 사용
const computerChoice = (imgCoords: ImgCoords) => {
  // Object.keys 강제 형변환 (as ["바위", "가위", "보"]) 이렇게
  // undefined 되지 않도록 ! 사용
...
const RSP = () => {
  ...
  return (
    <>
      ...
      />
      <div>
        {/* React 고차함수. 여기서 함수 호출하면 const ~ 선언부분에서도 고차함수로 변경 */}
